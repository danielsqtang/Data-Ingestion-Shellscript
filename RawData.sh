...
sqoop import --connect jdbc:mysql://52.207.2.108/northwind --username temp --password temp --delete-target-dir --target-dir /user/daniel/projectscript/NorthwindCustomers --m 1 \
